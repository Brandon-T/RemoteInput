...
PyMethodDef PyEIOS_Methods[] = {
        {(char*)"inject",                 PYTHON_FASTCALL(Python_EIOS_Inject),               METH_STATIC | METH_FASTCALL, PyDoc_STR("inject('process_name', /)\n--\n\nInjects into a process by name")},
        {(char*)"inject_pid",             PYTHON_FASTCALL(Python_EIOS_Inject_PID), METH_STATIC | METH_FASTCALL,           PyDoc_STR("inject_pid(process_pid)\n--\n\nInjects into a process by PID")},
        {(char*)"from_pid",               PYTHON_FASTCALL(Python_EIOS_From_PID), METH_STATIC | METH_FASTCALL,             PyDoc_STR("Gets an existing EIOS by PID")},
        {(char*)"request_target",         PYTHON_FASTCALL(Python_EIOS_RequestTarget), METH_STATIC | METH_FASTCALL,        PyDoc_STR("Requests an EIOS by PID, and Pairs to it if not already paired")},
        ...
        {(char*)"update_image_buffer",    PYTHON_FASTCALL(Python_EIOS_UpdateImageBuffer),    METH_FASTCALL,       (char*)""},
        ...
        {(char*)"get_graphics_scaling",       PYTHON_FASTCALL(Python_EIOS_GetGraphicsScaling),     METH_FASTCALL, (char*)""},
        {(char*)"set_graphics_scaling",       PYTHON_FASTCALL(Python_EIOS_SetGraphicsScaling),     METH_FASTCALL, (char*)""},
        {(char*)"pair_client",                PYTHON_FASTCALL(Python_EIOS_PairClient),        METH_FASTCALL | METH_STATIC, (char*)""},
        ...
        {(char*)"kill_zombie_clients",       PYTHON_FASTCALL(Python_EIOS_KillZombieClients), METH_NOARGS | METH_STATIC,  (char*)""},
        {(char*)"get_clients",               PYTHON_FASTCALL(Python_EIOS_GetClients),   METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"get_client_pid",            PYTHON_FASTCALL(Python_EIOS_GetClientPID), METH_FASTCALL | METH_STATIC,      (char*)""},

        {(char*)"reflect_object",            PYTHON_FASTCALL(Python_Reflect_Object), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"is_same_object",            PYTHON_FASTCALL(Python_Reflect_IsSame_Object), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"is_instance_of",            PYTHON_FASTCALL(Python_Reflect_InstanceOf), METH_FASTCALL | METH_STATIC,      (char*)""},
        //{(char*)"release_objects",            PYTHON_FASTCALL(Python_Reflect_Release_Objects), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"reflect_bool",            PYTHON_FASTCALL(Python_Reflect_Bool), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"reflect_char",            PYTHON_FASTCALL(Python_Reflect_Char), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"reflect_byte",            PYTHON_FASTCALL(Python_Reflect_Byte), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"reflect_short",            PYTHON_FASTCALL(Python_Reflect_Short), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"reflect_int",            PYTHON_FASTCALL(Python_Reflect_Int), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"reflect_long",            PYTHON_FASTCALL(Python_Reflect_Long), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"reflect_float",            PYTHON_FASTCALL(Python_Reflect_Float), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"reflect_double",            PYTHON_FASTCALL(Python_Reflect_Double), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"reflect_string",            PYTHON_FASTCALL(Python_Reflect_String), METH_FASTCALL | METH_STATIC,      (char*)""},
        {(char*)"reflect_array",            PYTHON_FASTCALL(Python_Reflect_Array), METH_FASTCALL | METH_STATIC,      (char*)""},
        {nullptr}  /* Sentinel */
};
...
PyObject* Python_EIOS_GetImageBuffer(PyEIOS* self, PyObject* args[], Py_ssize_t args_length) noexcept
{
    ...
    return python->PyLong_FromVoidPtr(buffer);
}
...
PyObject* Python_EIOS_UpdateImageBuffer(PyEIOS* self, PyObject* args[], Py_ssize_t args_length) noexcept
{
    #ifdef PYTHON_API_VALIDATION
    if (args_length != 0)
    {
    ...
    EIOS_UpdateImageBuffer(python_get_eios(self));
...
PyObject* Python_EIOS_HoldMouse(PyEIOS* self, PyObject* args[], Py_ssize_t args_length) noexcept
{
    ...
    EIOS_HoldMouse(python_get_eios(self), from_python_object<std::int32_t>(args[0]), from_python_object<std::int32_t>(args[1]), from_python_object<std::int32_t>(args[2]));
...
PyObject* Python_EIOS_ReleaseMouse(PyEIOS* self, PyObject* args[], Py_ssize_t args_length) noexcept
{
    ...
    EIOS_ReleaseMouse(python_get_eios(self), from_python_object<std::int32_t>(args[0]), from_python_object<std::int32_t>(args[1]), from_python_object<std::int32_t>(args[2]));
...
PyObject* Python_EIOS_ScrollMouse(PyEIOS* self, PyObject* args[], Py_ssize_t args_length) noexcept
{
    ...
    EIOS_ScrollMouse(python_get_eios(self), from_python_object<std::int32_t>(args[0]), from_python_object<std::int32_t>(args[1]), from_python_object<std::int32_t>(args[2]));
...
PyObject* Python_EIOS_GetGraphicsScaling(PyEIOS* self, PyObject* args[], Py_ssize_t args_length) noexcept
{
    #ifdef PYTHON_API_VALIDATION
    if (args_length != 0)
    {
    ...
    return to_python_object(EIOS_GetGraphicsScaling(python_get_eios(self)));
}

PyObject* Python_EIOS_SetGraphicsScaling(PyEIOS* self, PyObject* args[], Py_ssize_t args_length) noexcept
{
    #ifdef PYTHON_API_VALIDATION
    if (args_length != 1)
    {
    ...
    EIOS_SetGraphicsScaling(python_get_eios(self), from_python_object<std::int32_t>(args[0]));
    
    (python->Py_INCREF)(python->Py_GetNone_Object());
    return python->Py_GetNone_Object();
}

PyObject* Python_EIOS_PairClient(PyEIOS* self, PyObject* args[], Py_ssize_t args_length) noexcept
{
    #ifdef PYTHON_API_VALIDATION
    if (args_length != 1)
    {
...
PyObject* Python_EIOS_KillZombieClients(PyEIOS* self, PyObject* args[], Py_ssize_t args_length) noexcept
{
    #ifdef PYTHON_API_VALIDATION
    if (args_length != 0)
    {
...
PyObject* Python_EIOS_GetClients(PyEIOS* self, PyObject* args[], Py_ssize_t args_length) noexcept
{
    #ifdef PYTHON_API_VALIDATION
    if (args_length != 1)
    {
    ...
    return to_python_object(EIOS_GetClients(from_python_object<bool>(args[0])));
}

PyObject* Python_EIOS_GetClientPID(PyEIOS* self, PyObject* args[], Py_ssize_t args_length) noexcept
{
    #ifdef PYTHON_API_VALIDATION
    if (args_length != 1)
    {
    ...
    std::string error;
    if (!type_python_is_valid<std::size_t>(args[0], error))
    {
        PyErr_Format(PyExc_TypeError, "Invalid Argument: %s. Expected 'index: Int'", error.c_str());
        return nullptr;
    }
    #endif

    return to_python_object(EIOS_GetClientPID(from_python_object<std::size_t>(args[0])));
}